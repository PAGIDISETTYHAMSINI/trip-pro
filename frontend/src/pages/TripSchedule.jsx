...
import { MapPin, Calendar, Clock, Sun, Sunset, Moon, ArrowLeft } from 'lucide-react';
...
export const TripSchedule = () => {
  ...
  return (
    <div className="container" style={{ padding: '4rem 0' }}>
      ...
      <div className="glass" style={{ padding: '2rem', marginBottom: '2rem', borderLeft: '5px solid var(--primary)' }}>
